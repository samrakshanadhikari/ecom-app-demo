        ...
        <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 leading-tight mb-6">
              Discover the best <span className="text-blue-600">products</span> <br />
            ...
            <a href="#categories" className="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg text-lg font-medium hover:bg-blue-700 transition duration-200 shadow-md">
              Shop Now
            </a>
